   ...
   let futuretemp = document.querySelector(".temperatureFuture");
    ...
    if (navigator.geolocation) // if this location exists in browser
    {
        ...
        // gives the current location as coords
        {
            ...
            const api = `${proxy}https://api.darksky.net/forecast/<Enter your api number here>/${lat},${long}`
            ...
            fetch(api)
                ...
                .then(data => {
                    ...
                    const dailyWeather = data.hourly.summary;
                    temperatureDegree.textContent = Math.floor(temperature);
                   temperatureDescription.textContent = dailyWeather;
